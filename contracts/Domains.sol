...
contract Domains is ERC721URIStorage {
    ...
    // modifier onlyValidDomainName(string calldata name) {
    //     require(isDomainNameValid(name));
    //     _;
    // }
    ...
    function isDomainNameValid(string calldata name)
        public
        pure
        returns (bool)
    {
    ...
    function register(string calldata name) public payable {
        ...
        if (!isDomainNameValid(name)) revert InvalidName(name);
